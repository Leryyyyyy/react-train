...
class Players extends React.Component{
    constructor(props) {
        ...
        super(props);
        this.state = {Inputs1:'',button1:null,Inputs2:'',button2:null,input1:true,input2:true,button3:null};
      }
    ...
    player4=(e)=>{
        ...
        if(this.state.button1=='1'){ this.setState({ button3:e}); }
         ...
         render( ){ 
           ...
           const button2= this.state.button2;
           const button3= this.state.button3;
           const Inputs1 =this.state.Inputs1;
           ...
           const path ={
            ...
            return (
              ...
              <div style={{paddingBottom:'150px',display:'block', backgroundColor: '#e8e8e8'}}>
                  <h1 style={{textAlign:'center',fontSize:'35px',fontWeight:300,padding:'60px 0'}}>Players</h1>
                        <div style={{width: '90%', backgroundColor: '#e8e8e8', margin: '0 auto',display:'flex',justifyContent:'space-around'}}>
                                <div style={{width:'40%',display:'flex',flexDirection:'column'}}>
                                    <label  style={{fontSize:'20px',margin:'5px 0',fontWeight:300}}>Player one</label>
                            {button1?(<div style={{display:'flex' ,backgroundColor:'#d9d9d9', borderRadius:'3px',}}>
                                          <div  style={{display:'flex',flex:1,fontSize:'20px',padding:'10px',}}>
                                            <img src={"https://github.com/"+Inputs1+".png?size=200"} alt="" style={{width:'55px',height:'55px',borderRadius:'20px',fontSize:'20px'}}/>
                                            <a href={"https://github.com/"+Inputs1} style={{margin:'auto',marginLeft:'10px',color:'rgb(187, 46, 31)',textDecoration:'none',fontWeight:'bold',fontSize:'20px',fontFamily:'-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen-Sans,Ubuntu,Cantarell,Helvetica Neue,sans-serif',}}>{this.state.Inputs1}</a>  
                                          </div> 
                                        <button onClick={this.player2.bind(this, null)}style={{display:'flex',marginRight:'20px',backgroundColor:'rgb(217, 217, 217)',border:'none'}} ><svg style={{margin:'auto'}} t="1574147421427" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2300" width="32" height="32">
                                            ...
                                            <input  onKeyUp={this.player1.bind(this)}   type="text" placeholder="github username" style={{flex:2,fontSize:'16px',marginRight:'10px',padding:'8px',borderRadius:'3px',border:'none',boxShadow:'inset 0 1px 2px rgba(0,0,0,0.15)',background:'rgba(0,0,0,0.02)'}}  defaultValue={this.state.Inputs1}/>
                                            <button onClick={this.player2.bind(this,'1')} style={{flex:1,fontSize:'16px',border:'none',cursor:'pointer',letterSpacing:'.25em',background:'black',color:'#c7c7c7'}}  disabled={this.state.input1}>submit</button>
                                        </div>)}
                                    
                                </div>    
                                <div style={{width:'40%',display:'flex',flexDirection:'column'}}>
                                    <label htmlFor="username2" style={{fontSize:'20px',margin:'5px 0',fontWeight:300}}>Player one</label>
                                    {button2?(<div style={{display:'flex' ,backgroundColor:'#d9d9d9', borderRadius:'3px',}}>
                                          <div  style={{display:'flex',flex:1,fontSize:'20px',padding:'10px',}}>
                                            <img src={"https://github.com/"+Inputs2+".png?size=200"} alt="" style={{width:'55px',height:'55px',borderRadius:'20px',fontSize:'20px'}}/>
                                            <a href={"https://github.com/"+Inputs2} style={{margin:'auto',marginLeft:'10px',color:'rgb(187, 46, 31)',textDecoration:'none',fontWeight:'bold',fontSize:'20px',fontFamily:'-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen-Sans,Ubuntu,Cantarell,Helvetica Neue,sans-serif',}}>{this.state.Inputs2}</a>  
                                          </div> 
                                        <button onClick={this.player4.bind(this, null)}style={{display:'flex',marginRight:'20px',backgroundColor:'rgb(217, 217, 217)',border:'none'}} ><svg style={{margin:'auto'}} t="1574147421427" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2300" width="32" height="32">
                                            <path d="M868.8618721348225 155.1381278651774C671.9145181736234-42.65088145483037 352.0854818263766-42.65088145483037 155.1381278651774 155.1381278651774-42.65088145483037 352.0854818263766-42.65088145483037 671.9145181736234 155.1381278651774 868.8618721348225s516.776390308446 196.9473539611993 714.5653996284539 0C1066.6508814548304 671.9145181736234 1066.6508814548304 352.0854818263766 868.8618721348225 155.1381278651774zM738.4052915194983 702.2141110907309c10.099864305702527 10.099864305702527 10.099864305702527 26.091316123064857 0 35.34952506995884-5.049932152851263 5.049932152851263-11.783175023319615 7.5748982292768945-17.67476253497942 7.5748982292768945s-12.624830382128154-2.5249660764256316-17.67476253497942-7.5748982292768945L512 547.3495250699589l-190.2141110907309 190.2141110907309c-5.049932152851263 5.049932152851263-11.783175023319615 7.5748982292768945-17.67476253497942 7.5748982292768945s-12.624830382128154-2.5249660764256316-17.67476253497942-7.5748982292768945c-10.099864305702527-10.099864305702527-10.099864305702527-26.091316123064857 0-35.34952506995884L476.6504749300412 512 285.5947084805016 321.78588890926915c-10.099864305702527-10.099864305702527-10.099864305702527-26.091316123064857 0-35.34952506995884 10.099864305702527-10.099864305702527 26.091316123064857-10.099864305702527 35.34952506995884 0L512 476.6504749300412l190.2141110907309-190.2141110907309c10.099864305702527-10.099864305702527 26.091316123064857-10.099864305702527 35.34952506995884 0 10.099864305702527 10.099864305702527 10.099864305702527 26.091316123064857 0 35.34952506995884L547.3495250699589 512 738.4052915194983 702.2141110907309z" fill="#d81e06" p-id="2301"></path></svg></button>
                                        </div>):(<div style={{display:'flex'}}>
                                            <input  onKeyUp={this.player3.bind(this)}   type="text" placeholder="github username" style={{flex:2,fontSize:'16px',marginRight:'10px',padding:'8px',borderRadius:'3px',border:'none',boxShadow:'inset 0 1px 2px rgba(0,0,0,0.15)',background:'rgba(0,0,0,0.02)'}} defaultValue={this.state.Inputs2}/> 
                                            <button onClick={this.player4.bind(this,'1')} style={{flex:1,fontSize:'16px',border:'none',cursor:'pointer',letterSpacing:'.25em',background:'black',color:'#c7c7c7'}}  disabled={this.state.input2}>submit</button>
                                        </div>)}   
                       ...
                       {button3?<Link  to={path}  style={{display:'flex',flex:1,fontSize:'16px',border:'none',cursor:'pointer',letterSpacing:'.25em',background:'black',color:'#c7c7c7',margin:'40px auto',padding:'10px',textTransform:'uppercase',letterSpacing:'0.25em',borderRadius:'3px',border:'none',fontSize:'16px',justifyContent:'center',alignitems:'center',cursor:'pointer',textDecoration:'none',maxWidth:'250px'}} >Battle</Link>:<div/>}
